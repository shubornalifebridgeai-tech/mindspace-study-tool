...
export const TABS: Tab[] = [
    { id: 'help', labelKey: 'tab_help', tooltipKey: 'tooltip_tab_help' },
    { id: 'input', labelKey: 'tab_input', tooltipKey: 'tooltip_tab_input' },
    ...
    { id: 'studyBuddy', labelKey: 'tab_studyBuddy', tooltipKey: 'tooltip_tab_studyBuddy' },
